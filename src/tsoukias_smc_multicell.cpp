 ...
 * int i and j are the indices of the SMC being simulated.
...
void tsoukias_smc(grid_parms grid, celltype1** smc)
{
	...
	// SYSTEM OF EQNS OF A SINGLE VASCULAR SMOOTH MUSCLE CELL ELECROPHYSIOLOGY MODEL.
