...
int main(int argc, char* argv[])
{
	...
	// Now allocate memory space for the structures representing the two cells grids and the various members of those structures.
	...
	// The seg_config variables are for recording the configuration of the split of the buffering in each direction.
	...
	// Call communication to the number of elements to be received by neighbours and allocate memory of recvbuf for each direction accordingly.
	grid = communicate_num_recv_elements_to_nbrs(grid);

	// Memory allocation for the receiving buffers.
	...
	// Data to receive from the neighbour in DOWN direction.
