...
#define		dbar_L	   			4	// L-type Ca SS d gate probability.
#define 	fbar_L	    		5	// L-type Ca SS f gate probability.
#define 	tau_dL				6	// L-type Ca d gate time constant.
#define 	tau_fL				7	// L-type Ca f gate time constant.
#define 	I_VOCC				8	// L-type Ca total channel current
#define		P_KCa				9	// BKCa total fast/slow gate probability.
...
#define		V_half_KCa			13	// BKCa 1/2 max act member potential.
#define		pbar_o	    		14	// BKCa SS fast/slow gate probability.
...
#define 	I_tr				46	// Diff current between SR_u and SR_r.
