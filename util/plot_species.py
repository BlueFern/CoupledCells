...
def plot(args):
    ...
    if args.model[0].lower() == "o":
        columns += ['t']
        
    elif args.model[0].lower() == "b":
        columns += ['ec_Gprot',
                    'ec_P_P2Y',
                    'ec_J_ind_I',
                    't'
    ...
    elif args.model[0].lower() == "l":
        columns += ['ec_Gprot', #active g proteins
        ...
        exit("expecting specified model (str)")
    ...
    for i in range(0, len(columns) - 1):
        ...
        tmp = fig1.add_subplot(num_rows, num_columns, val)
        val += 1
...
if __name__ == "__main__":
    ...
    argParser.add_argument('model', type=str, help='Specifies if the original,\
    lemon, or bennett model should be used. Use strings "o", "l", or "b" for the respective models.')
